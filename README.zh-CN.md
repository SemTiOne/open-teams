...
1. 打开 AI 工具（Cursor / Copilot / Claude Code），AI 会自动读取 `AGENTS.md` 中的工作空间约束
2. 通过对话让 AI 帮你适配 `AGENTS.md`、选择 Skills、建立项目上下文
3. 开始用 AI 协作，`memory/` 由 AI 自动记录每日决策

> 💡 **你不需要手动编辑任何文件。** 告诉 AI 你的需求，它来维护。
...
| 版本 | 内容 | 状态 |
|------|------|------|
| v0.1 - v0.4 | 核心工作空间结构、Skills、init.sh、CI/CD、模板校验 | ✅ 已完成 |
| v0.5 | VS Code 插件 + CLI 工具增强 | 📋 计划中 |
| v0.6 | Web Dashboard + 工作空间健康检查可视化 | 📋 计划中 |
